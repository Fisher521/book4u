...
- 破茧 #1【思想出口】：用一个**理性框架/经典文本**让 ta 重新看自己的处境。比 ta 当下感触深一层、稳一层。如 ta 在哀悼 → 推 Joan Didion / C.S. Lewis 写丧失（不是治愈鸡汤，是把丧失说清楚的书）；ta 缓存 Jung 视频 → 推 Jung 自传（第一手震撼）。
- 破茧 #2【经验出口】：看一个**走过同样状态的人**怎么走出来。可以跨文化/跨体裁——不是为陌生而陌生，是为"原来还有这种活法"。

**味道仍跟 MBTI**——破茧也是 ta 会读的书，不是硬塞 ta 不喜欢的调子。

**类型多样性（硬规则）**：5 本以**文学性为主，但不要全是文学作品**。至少 1 本是非纯文学（历史/哲学/科普/社科/纪实/传记/艺术/写作技艺/自然志）。
- 一般落在 共鸣 #3 或 破茧 #1。
- 5 本全是小说+散文 → 替换 1 本。
- 这本仍要"有文学性 + 味道对"——Robert Caro 文学性历史、Annie Dillard 自然志，不是干瘪学术史。
